    ...
    return __c(
        ...
        [
            __c(
                "i",
                {
                    style:"min-height:40px;min-width:40px;display:flex;align-items:center;justify-content:center;border-radius:50%;font-size:20px;color:#246696;border:2px solid #246696;",
    ...
    return __c(
        ...
        [
            ...
            __c(
                "i",
                {
                    style:"min-height:40px;min-width:40px;display:flex;align-items:center;justify-content:center;border-radius:50%;font-size:20px;border:2px solid #246696;color:#F4D03F;",
